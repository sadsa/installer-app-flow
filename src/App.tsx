...
const CoreHubDiscoveredNotInstalled = ({ onInstall, onReplace }) => {
  return (
    <div className="p-4">
      <h2 className="mb-4 text-2xl font-bold">CoreHub - Discovered - Not Installed</h2>
      <button
        onClick={onInstall}
...
const CoreHubDiscoveredInstalled = ({ onDiagnostics, onManageDevices, onUninstall }) => {
  return (
    <div className="p-4">
      <h2 className="mb-4 text-2xl font-bold">CoreHub - Discovered - Installed</h2>
      <button
...
const AccountManagement = () => {
  return (
    <div className="p-4">
      ...
      <p>Here you can manage your account details, change password, and set preferences.</p>
    </div>
  );
};
      ...
      <div className="min-h-screen bg-gray-100">
        <nav className="p-4 bg-white shadow">
          <div className="flex justify-between">
            ...
            <div>
              <button onClick={() => window.location.href='/account'} className="mr-4">
                <Settings size={24} />
              </button>
